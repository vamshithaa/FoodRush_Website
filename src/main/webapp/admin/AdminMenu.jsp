...
<title>Manage Menu - FoodRush Admin</title>
...
<button class="hamburger" id="hamburgerBtn"><i class="fa-solid fa-bars"></i></button>
  ...
  <div class="main">
    <a class="back-link" href="${pageContext.request.contextPath}/admin/restaurants"><i class="fa-solid fa-arrow-left"></i> Back to Restaurants</a>

    <div class="top-row">
      <div>
        <h1>Menu &ndash; <%=restuarantName%></h1>
        <div class="sub">Manage menu items for this restaurant</div>
      </div>
            ...
            <tr>
              ...
              <td>
                <div class="actions-cell">
                  ...
                  <a href="<%=request.getContextPath()%>/admin/menu?action=delete&id=<%=m.getMenuId()%>&restuarantId=<%=restuarantId%>"
...
<div class="modal-overlay" id="menuModal">
  <div class="modal">
    ...
    <form id="menuForm" method="post" action="${pageContext.request.contextPath}/admin/menu" enctype="multipart/form-data">
...
// Wire up every "Edit" pencil icon to open the modal pre-filled,
// reading values from data-* attributes (avoids manual JS-string escaping).
...
<%
  ...
  if (editMenu != null) {
%>
// Server told us we're editing a specific item (e.g. after a validation redirect) - open it now.
openEditModal(
  <%=editMenu.getMenuId()%>,
